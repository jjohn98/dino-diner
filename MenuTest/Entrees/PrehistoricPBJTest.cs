...
namespace MenuTest.Entrees
{
    public class PrehistoricPBJUnitTest
    {
        ...
        [Fact]
        public void SpecialShouldBeCorrectByDefault()
        {
            PrehistoricPBJ pbj = new PrehistoricPBJ();
        ...
        [Fact]
        public void SpecialShouldBeCorrectAfterHoldingPeanutButter()
        {
            PrehistoricPBJ pbj = new PrehistoricPBJ();
            pbj.HoldPeanutButter();
        ...
        [Fact]
        public void SpecialShouldBeCorrectAfterHoldingJelly()
        {
            PrehistoricPBJ pbj = new PrehistoricPBJ();
            pbj.HoldJelly();
            Assert.Collection<string>(pbj.Special, item =>
        ...
        [Fact]
        public void SpecialShouldBeCorrectAfterHoldingPBJ()
        {
            PrehistoricPBJ pbj = new PrehistoricPBJ();
            pbj.HoldPeanutButter();
            pbj.HoldJelly();
